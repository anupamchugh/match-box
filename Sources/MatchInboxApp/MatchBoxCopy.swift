...
enum MatchBoxCopy {
    ...
    static let basedOnWhatYouShared: LocalizedStringKey = "Based on what you shared"
    static let whatMayBeMissing: LocalizedStringKey = "What may be missing"
    static let whatMayBeMissingText = "What may be missing"
